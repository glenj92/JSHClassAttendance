...
public class ListaAsignaturaRegistrar extends Activity implements OnQueryTextListener {
...
getMenuInflater().inflate(R.menu.menu_buscar, menu);
	...
	private Handler puentemate = new Handler() {
   	 ...
   	 public void handleMessage(Message msg) {
   		...
   		if(msg.obj.toString().trim().equals("cxerror")){
    		AlertDialog.Builder dialogo1 = new AlertDialog.Builder(ListaAsignaturaRegistrar.this);  
	      ...
	      //obligamos al usuario a pulsar los botones para cerrarlo
	       ...
	       dialogo1.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {  
	        ...
	        dialogo1.setMessage("No hay Materias registradas\nPor favor notificarle al administrador de la Base de Datos"); 
	      //obligamos al usuario a pulsar los botones para cerrarlo
	        dialogo1.setCancelable(false);   
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lista_materia_registrar);
		lvmateria=(ListView)findViewById(R.id.llvlistamateriaregistarmateria);
	...
	bundle = getIntent().getExtras();
		...
		dial= ProgressDialog.show(ListaAsignaturaRegistrar.this, "", "Cargando datos...",true);
		...
		listaMate.removeAll(listaMate);
		 boolean algunDigito = false; 
	        ...
	        if(algunDigito && !algunaLetra){ 
	        	//NUMERICO
	        	dial= ProgressDialog.show(ListaAsignaturaRegistrar.this, "", "Buscando por Codigo...",true);
	        	dial.setCancelable(true);
	        	...
	        	//LETRA
	        	dial= ProgressDialog.show(ListaAsignaturaRegistrar.this, "", "Buscando por Nombres...",true);
	        	dial.setCancelable(true);
	        	//dial.setCancelable(true);
	            Thread thr = new Thread(new Runnable() {
	  			  @Override
