...
public class ListaCursoRegistrar extends Activity implements OnQueryTextListener {
...
getMenuInflater().inflate(R.menu.menu_buscar, menu);
    ...
    private Handler puentecur = new Handler() {
   	...
   	// Toast.makeText(getApplicationContext(), (String)msg.obj, Toast.LENGTH_LONG).show();
   		...
   		if(msg.obj.toString().trim().equals("cxerror")){
    		AlertDialog.Builder dialogo1 = new AlertDialog.Builder(ListaCursoRegistrar.this);  
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lista_curso_registrar);
		
		prefe=getSharedPreferences("datos",Context.MODE_PRIVATE);
		
		lvcurso=(ListView)findViewById(R.id.lvlistacursoregistrarsursoos);
		listaCurso=new ArrayList<String>();
		adaptCurso =new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,listaCurso);
	
		
		dial= ProgressDialog.show(ListaCursoRegistrar.this, "", "Cargando datos...",true);
		...
		listaCurso.removeAll(listaCurso);
		 boolean algunDigito = false; 
	        ...
	        if(algunDigito && !algunaLetra){ 
	        	//NUMERICO
	        	dial= ProgressDialog.show(ListaCursoRegistrar.this, "", "Buscando por Codigo...",true);
	        	dial.setCancelable(true);
	        	...
	        	//LETRA
	        	dial= ProgressDialog.show(ListaCursoRegistrar.this, "", "Buscando por Nombres...",true);
	        	dial.setCancelable(true);
	        	//dial.setCancelable(true);
	            Thread thr = new Thread(new Runnable() {
	  			  @Override
