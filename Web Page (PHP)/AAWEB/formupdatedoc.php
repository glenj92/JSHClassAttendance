...
<div id="peP" style="border: 2px solid #33B5E5; border-radius:8px; margin-top:10px; margin-bottom:10px; padding-top:5px; padding-bottom:5px; background:#33B5E5;">
 ...
 <center>
  <a href="gestiondocente.php" class="button button-border" style="margin-top:5px; margin-bottom:5px;">Atras</a>
...
";
	...
	<tbody>
  <tr class='alt'>
  <form action='updatedocente.php?user2=".$user."' method='post'>
...
";
	...
	echo"
  <tr>
  <form action='gestiondocente.php' method='post'>
    <td><input name='usuario' type='text' value='".$user."'/></td>
	...
	<option value='4'>Escritor de Tag</option>
	</select></td>
	<td><input type='submit' value='Actualizar'/></td>
	</form>
  </tr>
...
<br/>
<br/>
<a href='gestiondocente.php'>Atras</a>
";
	}
	if($per==2){
	echo"
	<option value='1'>Administrador</option>
	<option selected='selected' value='2'>Docentes Universotarios</option>
	<option value='3'>Docentes de Escuelas</option>
	<option value='4'>Escritor de Tag</option>
	</select></td>
	<td><input type='submit' value='Actualizar'/></td>
...
";
	...
	<option value='1'>Administrador</option>
	<option value='2'>Docentes Universotarios</option>
	<option selected='selected' value='3'>Docentes de Escuelas</option>
	<option value='4'>Escritor de Tag</option>
	</select></td>
	<td><input type='submit' value='Actualizar'/></td>
	</form>
