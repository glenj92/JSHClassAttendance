...
<div id="peP" style="border: 2px solid #33B5E5; border-radius:8px; margin-top:10px; margin-bottom:10px; padding-top:5px; padding-bottom:5px; background:#33B5E5;">
  ...
  <center>
  <?php
 echo" <a href='formupdatemate.php?codigo=".$cod."&nombre=".$nom."&pro=".$pro."' class='button button-border' style='margin-top:5px; margin-bottom:5px;'>Atras</a>";
    ?>
    </center>
...
<thead>
  <tr>
	...
	<form id='form1' name='form1' method='post' action='selccionprogramaup.php'>
	<th>
  	<p>
...
while($fi=mysql_fetch_array($consulta)){
	...
	<td><a href='formupdatemate.php?codigo=".$cod."&nombre=".$nom."&pro=".$fi[0]."'>Seleccionar</a></td>
