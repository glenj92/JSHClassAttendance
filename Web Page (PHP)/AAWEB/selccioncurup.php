...
<thead>
  <tr>
	...
	<form id='form1' name='form1' method='post' action='selccioncurup.php'>
	<th>
  	<p>
...
while($fi=mysql_fetch_array($consulta)){
	...
	<td><a href='formupdategru.php?cod=".$cod."&scodcup=".$fi[0]."&mate=".$codm."&ano=".$ano."&per=".$per."&jor=".$jor."&doc=".$idd."'>Seleccionar</a></td>
