...
<thead>
  <tr>
	...
	<form id='form1' name='form1' method='post' action='selcciondocup.php'>
		<th>
  	<p>
...
while($fi=mysql_fetch_array($consulta)){
	...
	<td><a href='formupdategru.php?cod=".$cod."&cur=".$codc."&mate=".$codm."&ano=".$ano."&per=".$per."&jor=".$jor."&siddocup=".$fi[0]."'>Seleccionar</a></td>
<td></td>
